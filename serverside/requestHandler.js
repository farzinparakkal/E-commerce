...
import addressSchema from "./models/user-address.model.js";
import sellerSchema from "./models/sellerDetail.model.js";
import productSchema from "./models/product.model.js";
import cartSchema from "./models/cart.model.js";
import sellerOrderSchema from "./models/sellerOrder.model.js";
import buyerOrderSchema from "./models/buyerOrder.model.js";
  ...
  if (!user) {
    ...
    align-items: center; justify-content: center; flex-direction: column;
     background-color: gainsboro;box-shadow: rgba(100, 100, 111, 0.2) 0px 7px 29px 0px; ">
        <h2>Email verification for reset Password</h2>
  ...
  if (user) {
    ...
    align-items: center; justify-content: center; flex-direction: column;
     background-color: gainsboro;box-shadow: rgba(100, 100, 111, 0.2) 0px 7px 29px 0px; ">
        ...
        <p>Click This Button to verify its you</p>
        <a href="http://localhost:5174/register"><button style="padding: 5px 15px; border: none; border-radius: 4px; 
        background-color: white;box-shadow: rgba(100, 100, 111, 0.2) 0px 7px 29px 0px;
        font-size: 18px; color: red; font-style: italic;" >Verify</button></a>
    </div>`,
    });
